...
if "#{$options[:ports].split("-")[0].to_i}" > "#{$options[:ports].split("-")[1].to_i}" then
  puts "#{"I".colors}#{"n".colors}#{"p".colors}#{"u".colors}#{"t".colors} #{"F".colors}#{"r".colors}#{"o".colors}#{"m".colors} #{$options[:ports].split("-")[0].red} #{"g".colors}#{"r".colors}#{"e".colors}#{"a".colors}#{"t".colors}#{"e".colors}#{"r".colors} #{"O".colors}#{"f".colors} #{"I".colors}#{"n".colors}#{"p".colors}#{"u".colors}#{"t".colors} #{"t".colors}#{"o".colors} #{$options[:ports].split("-")[1].red}"
  exit(0)
end
...
def ip(port)
  ...
  if check
    ...
    begin
    puts "#{$options[:ip].to_s.cyan}#{":".colors}#{">".colors} #{port.to_s.green}#{"/".colors}#{"#{Socket.getservbyport(port)}".colors} #{"O".colors}#{"P".colors}#{"E".colors}#{"N".colors}"
    rescue SocketError
      puts "#{$options[:ip].to_s.cyan}#{":".colors}#{">".colors} #{port.to_s.green} #{"O".colors}#{"P".colors}#{"E".colors}#{"N".colors}"      end
  end
end
$PORTS = []
